...
const CK_GROUPS = {
  N1: {
    ...
    Glanzen: 0.60, Laborie: 0.45, 'Dr. For Skin': 0.40,
  },
  N2: {
    ten: 'Chuỗi & Sàn TMĐT',
    ...
    Glanzen: 0.50, Laborie: 0.41, 'Dr. For Skin': 0.38,
  },
  N3: {
    ...
    Glanzen: 0.45, Laborie: 0.37, 'Dr. For Skin': 0.35,
  },
  N4: {
    ...
    Glanzen: 0.35, Laborie: 0.34, 'Dr. For Skin': 0.33,
  },
  N5: {
    ...
    Glanzen: 0.25, Laborie: 0.30, 'Dr. For Skin': 0.30,
  },
  NQ: {
  ...
  CT5: {
    ...
    tiers: [
      ...
      { ten: 'Bậc 2', min_dt_thuc: 5_000_000,
        qua_text: '2 Laborie 250ml (chọn loại)',
        qua_sl: 2, qua_options: ['DG_269','DG_273','DG_272','DX_201','TD_054','MN_046','TD_053'] },
      { ten: 'Bậc 3', min_dt_thuc: 10_000_000,
        qua_text: '3 Laborie + 1 Mask + 1 Serum',
        qua_sl: 3, qua_fixed: [{sku:'MN_046', sl:1},{sku:'TD_053', sl:1}] },
      ...
      { ten: 'VIP', min_dt_thuc: 25_000_000,
        qua_text: '6 Laborie + 3 Mask + 2 Serum + 1 Hair Oil',
        qua_sl: 6, qua_fixed: [{sku:'MN_046', sl:3},{sku:'TD_053', sl:2},{sku:'TD_054', sl:1}] },
    ],
  },
  ...
  CT6: {
    ...
    tiers: [
      ...
      { ten: 'Bậc 3', min_dt_thuc: 15_000_000,
        qua_text: '3 Dabo Serum + 2 SRM Teatrea + 2 SRM Charcoal',
        qua: [{sku:'TC_005', sl:3},{sku:'SRM_097', sl:2},{sku:'SRM_104', sl:2}] },
    ],
  },
};
