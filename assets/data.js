...
const PROGRAMS = {
  ...
  CT2: {
    ...
    tiers: [
      ...
      { ten: 'VIP',   min_dt_thuc: 80_000_000, qua_text: '20 Laborie + 5 Mask + 3 Serum',
        qua_sl: 20, qua_fixed: [{sku:'MN_046', sl:5},{sku:'TD_053', sl:3}] },
      { ten: 'VIP+',  min_dt_thuc: 120_000_000, qua_text: '50 Laborie + 10 Mask + 5 Serum + 5 Hair Oil',
        qua_sl: 50, qua_fixed: [{sku:'MN_046', sl:10},{sku:'TD_053', sl:5},{sku:'TD_054', sl:5}] },
      { ten: 'SVIP',  min_dt_thuc: 200_000_000, qua_text: '80 Laborie + 15 Mask + 8 Serum + 8 Hair Oil',
        qua_sl: 80, qua_fixed: [{sku:'MN_046', sl:15},{sku:'TD_053', sl:8},{sku:'TD_054', sl:8}] },
    ],
  },
  CT3: {
    ten: 'Laborie Xả Kho',
  ...
  CT4: {
    ...
    tiers: [
      ...
      { ten: 'Bậc 2', min_dt_thuc: 5_000_000,
        qua_text: '1 SRM Teatrea + 1 SRM Charcoal',
        qua: [{sku:'SRM_097', sl:1},{sku:'SRM_104', sl:1}] },
      { ten: 'Bậc 3', min_dt_thuc: 10_000_000,
        qua_text: '1 Dabo Serum + 1 SRM Teatrea + 1 SRM Charcoal',
        qua: [{sku:'TC_005', sl:1},{sku:'SRM_097', sl:1},{sku:'SRM_104', sl:1}] },
      { ten: 'Bậc 4', min_dt_thuc: 15_000_000,
        qua_text: '2 Dabo Serum + 2 SRM Teatrea + 1 SRM Charcoal',
        qua: [{sku:'TC_005', sl:2},{sku:'SRM_097', sl:2},{sku:'SRM_104', sl:1}] },
      ...
      { ten: 'VIP+', min_dt_thuc: 40_000_000,
        qua_text: '5 Dabo Serum + 5 SRM Teatrea + 3 SRM Charcoal',
        qua: [{sku:'TC_005', sl:5},{sku:'SRM_097', sl:5},{sku:'SRM_104', sl:3}] },
      { ten: 'SVIP', min_dt_thuc: 60_000_000,
        qua_text: '12 Dabo Serum + 10 SRM Teatrea + 8 SRM Charcoal',
        qua: [{sku:'TC_005', sl:12},{sku:'SRM_097', sl:10},{sku:'SRM_104', sl:8}] },
    ],
  },
};
